...
public sealed record FleetMetricsResponse(double AveragePowerKw, double AverageWindMs, double AverageGearboxTempC, int CriticalAlertCount);
public sealed record FarmDashboardSummaryResponse(string FarmId, string FarmName, double AveragePowerKw, double AverageWindMs, double AverageGearboxTempC, int CriticalAlertCount);
...
public sealed record TurbineResponse(string TurbineId, string? TurbineName, string FarmId, string FarmName, double? AveragePowerKw, double? AverageWindMs, double? AverageGearboxTempC, int? CriticalAlertCount, TelemetrySeriesResponse PowerOutput, TelemetrySeriesResponse WindSpeed);
...
public sealed record TurbinePageMeta(string TurbineId, string FarmId, string FarmName, double? AveragePowerKw, double? AverageWindMs, double? AverageGearboxTempC, int? CriticalAlertCount);
